package com.copypasteit.Canada.LocationActivity;
...
public class LocationActivity extends FragmentActivity implements OnMapReadyCallback, RewardedVideoAdListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //apps pub id
        MobileAds.initialize(LocationActivity.this, "ca-app-pub-3010341507881755~9806831007");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng Monaco = new LatLng( 51.213890, -102.462776);
