package com.copypasteit.Canada.HomeActivity;
...
import com.copypasteit.Canada.GalleryActivity.GalleryActivity;
import com.copypasteit.Canada.GovernmentActivity.GovtActivity;
import com.copypasteit.Canada.LocationActivity.LocationActivity;
import com.copypasteit.Canada.MainActivity.MainActivity;
import com.copypasteit.Canada.R;

import com.copypasteit.Canada.SliderFragment.HistoryFragment;
import com.copypasteit.Canada.SliderFragment.SliderFragment;
import com.copypasteit.Canada.TouristFragment.TouristFragment;
...
public class HomeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener , RewardedVideoAdListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //apps pub id
        MobileAds.initialize(HomeActivity.this, "ca-app-pub-3010341507881755~9806831007");
        ...
        interstitialAd.setAdUnitId("ca-app-pub-3010341507881755/1736769296");
        loadInterstitialAd();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_share:
                ...
                String shareBody = "https://play.google.com/store/apps/details?id=com.copypasteit.Canada";
            ...
            case R.id.menu_privacy:
                ...
                Intent intentprivacy = new Intent(Intent.ACTION_VIEW, Uri.parse("https://apps.androwep.com/canada/privacy-policy.html"));
...
//    }
    ...
    public void WhenAndthemClicked(View view) {
        ...
        MediaPlayer mediaPlayer = MediaPlayer.create(this, R.raw.canada);
        mediaPlayer.start();
